...
class _ManualAssignmentScreenLargeState
  ...
  // Simplified version of the branch selector for the large screen sidebar
  Widget _buildBranchSelector(
      UserScopeService userScope, BranchFilterService branchFilter) {
    // Reusing logic but styling for sidebar
    return Container(
...
class _AssignmentDetailPaneState extends State<_AssignmentDetailPane> {
  ...
  Widget build(BuildContext context) {
    ...
    final targetBranchId = orderBranchId ?? widget.userScope.branchId;
