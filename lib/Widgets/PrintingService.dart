  ...
  static Future<void> _loadAssets() async {
    ...
    if (_cachedArabicFont == null) {
      try {
        ...
        debugPrint("⚠️ Error loading Arabic font from assets: $e");
        // Try Google Fonts Fallback
        try {
          _cachedArabicFont = await PdfGoogleFonts.notoSansArabicRegular();
          debugPrint("✅ Fallback Arabic font (Google Fonts) loaded");
        } catch (e2) {
          debugPrint("⚠️ Google Fonts fallback failed: $e2");
        }
      }
    }
    ...
    if (_cachedLogo == null && !_logoLoadAttempted) {
      ...
      try {
        ...
        debugPrint(
            "⚠️ Logo asset not found - receipts will print without logo.");
      }
    }
  }
  ...
  static Future<void> printReceipt(
    ...
    try {
      ...
      await Printing.layoutPdf(onLayout: (PdfPageFormat format) async {
        ...
        final pw.TextStyle fontReg =
            pw.TextStyle(font: regularFont, fontSize: fontSizeRegular);
        final pw.TextStyle fontBold = pw.TextStyle(
            font: regularFont,
            fontSize: fontSizeRegular,
            fontWeight: pw.FontWeight.bold);
        final pw.TextStyle fontSmall =
            pw.TextStyle(font: regularFont, fontSize: fontSizeSmall);
        ...
        pw.Widget bilingualRow(String en, String ar, String value,
            {bool isBold = false}) {
          return pw.Row(
              ...
              pw.Column(
                ...
                children: [
                  ...
                  if (ar.isNotEmpty && arabicFont != null)
                    pw.Text(ar,
                        style: isBold ? fontArBold : fontArReg,
            ...
            build: (pw.Context context) {
              return pw.Column(
                  ...
                  children: [
                    ...
                    if (arabicFont != null)
                      pw.Text(branchNameAr,
                          style: fontArBold.copyWith(fontSize: 12),
                          textDirection: pw.TextDirection.rtl),

                    if (branchAddress.isNotEmpty)
                      pw.Text(branchAddress,
                          style: fontReg.copyWith(fontSize: fontSizeSmall),
                          textAlign: pw.TextAlign.center),
                    if (branchPhone.isNotEmpty)
                      pw.Text("Tel: $branchPhone",
                          style: fontReg.copyWith(fontSize: fontSizeSmall)),
                    ...
                    pw.Container(
                        ...
                        child: pw.Column(children: [
                          bilingualRow("Order #", "رقم الطلب", dailyOrderNumber,
                              isBold: true),
                          pw.SizedBox(height: 2),
                          bilingualRow("Date", "التاريخ",
                          ...
                          if (isTakeaway && carPlateNumber.isNotEmpty)
                            bilingualRow(
                                "Car Plate",
                                "رقم لوحة السيارة",
                                carPlateNumber.length > 15
                                    ? "${carPlateNumber.substring(0, 12)}..."
                                    : carPlateNumber)
                          else
                            bilingualRow(
                                "Customer",
                          ...
                          if (isTakeaway && specialInstructions.isNotEmpty) ...[
                            ...
                            bilingualRow(
                                ...
                                specialInstructions.length > 20
                                    ? "${specialInstructions.substring(0, 17)}..."
                                    : specialInstructions),
                          ],
                        ])),
                          ...
                          pw.Container(
                              ...
                              child: pw.Column(children: [
                                ...
                                pw.Row(
                                    ...
                                    children: [
                                      pw.Text("Total Items",
                                          style: fontReg.copyWith(
                                              fontSize: 8,
                                              color: PdfColors.grey700)),
                                      pw.Text("$totalItemCount",
                                          style: fontReg.copyWith(
                                              fontSize: 8,
                                              color: PdfColors.grey700)),
                                    ]),
                          ...
                          pw.Expanded(
                              child: pw.Column(
                                ...
                                pw.Text("Thank you for dining with us!",
                                    style: fontBold),
                                if (arabicFont != null)
                                  pw.Text("شكرا لزيارتكم!",
                                      style: fontArBold,
                                      textDirection: pw.TextDirection.rtl),
                                pw.SizedBox(height: 2),
                                pw.Text("www.mitran-restaurant.com",
                                    style: fontReg.copyWith(
