...
class PrintingService {
  ...
  static Future<void> printReceipt(
    ...
    try {
      ...
      // Fallback Font
      final fontData = _cachedArabicFont ??
          await rootBundle.load("assets/fonts/NotoSansArabic-Regular.ttf");
      ...
      await Printing.layoutPdf(onLayout: (PdfPageFormat format) async {
        ...
        final String orderTypeRaw =
            (order['Order_type'] ?? 'Unknown').toString().toLowerCase();
        final String orderType =
            orderTypeRaw.toUpperCase().replaceAll('_', ' ');
        final String customerName =
            (order['customerName'] ?? 'Walk-in').toString();
        final String carPlateNumber =
            (order['carPlateNumber'] ?? '').toString();
        final bool isTakeaway = orderTypeRaw == 'takeaway';
        ...
        final pw.TextStyle fontBold = pw.TextStyle(
            fontSize: fontSizeRegular, fontWeight: pw.FontWeight.bold);
        final pw.TextStyle fontArReg =
            pw.TextStyle(font: arabicFont, fontSize: fontSizeRegular);
        final pw.TextStyle fontArBold = pw.TextStyle(
            font: arabicFont,
            ...
            build: (pw.Context context) {
              return pw.Column(
                  ...
                  children: [
                    ...
                    // --- TITLE ---
                    pw.Text("SALES RECEIPT / إيصال بيع",
                    ...
                    pw.Container(
                        ...
                        child: pw.Column(children: [
                          ...
                          pw.SizedBox(height: 2),
                          // Show Car Plate for takeaway, Customer Name for others
                          isTakeaway
                              ? bilingualRow(
                                  "Car Plate",
                                  "رقم السيارة",
                                  carPlateNumber.isNotEmpty
                                      ? carPlateNumber
                                      : "N/A")
                              : bilingualRow(
                                  "Customer",
